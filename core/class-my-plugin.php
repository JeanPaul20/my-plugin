...
final class My_Plugin{
	...
	{
		require_once MYPLUGIN_PLUGIN_DIR . 'core/class-autoloader.php';
		require_once MYPLUGIN_PLUGIN_DIR . 'core/includes/classes/class-my-plugin-helpers.php';
	...
	{
		load_plugin_textdomain($this->plugin_data['Text Domain'], FALSE, dirname($this->plugin_file_name) . '/languages/');
	}
